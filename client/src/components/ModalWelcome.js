    ...
    <div>
      ...
      >
        ...
        <div className="modal-body">
            ...
            <p>Phree-OS utilizes Stripe to process securely all of your credit card transactions. After signing up for <a href="https://connect.stripe.com/oauth/authorize?response_type=code&client_id=ca_FN84Sv7TjpDUCWLlVrZk9kLd4K9fVfW7&scope=read_write" onClick={props.close}>Stripe</a>, you'll be one of millions of business owners, 
